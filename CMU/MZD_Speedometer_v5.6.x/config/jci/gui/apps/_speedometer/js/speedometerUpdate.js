function updateSpeedoApp() {
  ...
  // --------------------------------------------------------------------------
  // Toggle Pressure (bar & psi)
  function togglePressUnit() {
  ...
  // Deutsch
    ...
    $('#tpmsFlPresFieldSet legend').html('RDKS VL <span class="spunit">(<span class="pressUnit">bar</span>)');
    $('#tpmsFrTempFieldSet legend').html('RDKS VR <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span>');
    $('#tpmsFrPresFieldSet legend').html('RDKS VR <span class="spunit">(<span class="pressUnit">bar</span>)');
    $('#tpmsRlTempFieldSet legend').html('RDKS HL <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span>');
    $('#tpmsRlPresFieldSet legend').html('RDKS HL <span class="spunit">(<span class="pressUnit">bar</span>)');
    $('#tpmsRrTempFieldSet legend').html('RDKS HR <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span>');
    $('#tpmsRrPresFieldSet legend').html('RDKS HR <span class="spunit">(<span class="pressUnit">bar</span>)');
  }
  // Türk
  else if (language === 'TR') {
  ...
  (pressIsPsi) ? $('.pressUnit').html('psi'):$('.pressUnit').html('bar');
