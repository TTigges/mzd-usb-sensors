...
function SpeedBarTmplt(uiaId, parentDiv, templateID, controlProperties) {
  ...
  this.divElt.innerHTML = '<!-- MZD Speedometer v5 - Digital Bar Mod -->' +
    ...
    '       <div class="oilTempValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="oilPresFieldSet" class="' +
    ((spdTbl.oilPres[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.oilPres[1]) + " pos" + spdTbl.oilPres[2] + '">' +
    '       <legend class="vehDataLegends">Oil Press. <span class="spunit">(<span class="pressUnit">bar</span>)</span></legend>' +
    '       <div class="oilPresValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsFlTempFieldSet" class="' +
    ((spdTbl.tpmsFlTemp[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsFlTemp[1]) + " pos" + spdTbl.tpmsFlTemp[2] + '">' +
    '       <legend class="vehDataLegends">TPMS FL <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span></legend>' +
    '       <div class="tpmsFlTempValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsFrTempFieldSet" class="' +
    ((spdTbl.tpmsFrTemp[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsFrTemp[1]) + " pos" + spdTbl.tpmsFrTemp[2] + '">' +
    '       <legend class="vehDataLegends">TPMS FR <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span></legend>' +
    '       <div class="tpmsFrTempValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsRlTempFieldSet" class="' +
    ((spdTbl.tpmsRlTemp[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsRlTemp[1]) + " pos" + spdTbl.tpmsRlTemp[2] + '">' +
    '       <legend class="vehDataLegends">TPMS RL <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span></legend>' +
    '       <div class="tpmsRlTempValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsRrTempFieldSet" class="' +
    ((spdTbl.tpmsRrTemp[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsRrTemp[1]) + " pos" + spdTbl.tpmsRrTemp[2] + '">' +
    '       <legend class="vehDataLegends">TPMS RR <span class="spunit">(&deg;<span class="tempUnit">C</span>)</span></legend>' +
    '       <div class="tpmsRrTempValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsFlPresFieldSet" class="' +
    ((spdTbl.tpmsFlPres[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsFlPres[1]) + " pos" + spdTbl.tpmsFlPres[2] + '">' +
    '       <legend class="vehDataLegends">TPMS FL <span class="spunit">(<span class="pressUnit">bar</span>)</span></legend>' +
    '       <div class="tpmsFlPresValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsFrPresFieldSet" class="' +
    ((spdTbl.tpmsFrPres[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsFrPres[1]) + " pos" + spdTbl.tpmsFrPres[2] + '">' +
    '       <legend class="vehDataLegends">TPMS FR <span class="spunit">(<span class="pressUnit">bar</span>)</span></legend>' +
    '       <div class="tpmsFrPresValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsRlPresFieldSet" class="' +
    ((spdTbl.tpmsRlPres[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsRlPres[1]) + " pos" + spdTbl.tpmsRlPres[2] + '">' +
    '       <legend class="vehDataLegends">TPMS RL <span class="spunit">(<span class="pressUnit">bar</span>)</span></legend>' +
    '       <div class="tpmsRlPresValue">0.00</div>' +
    '     </fieldset>' +
    '     <fieldset id="tpmsRrPresFieldSet" class="' +
    ((spdTbl.tpmsRrPres[0] === 0) ? "vehDataMain" : "vehDataBar" + spdTbl.tpmsRrPres[1]) + " pos" + spdTbl.tpmsRrPres[2] + '">' +
    '       <legend class="vehDataLegends">TPMS RR <span class="spunit">(<span class="pressUnit">bar</span>)</span></legend>' +
    '       <div class="tpmsRrPresValue">0.00</div>' +
    '     </fieldset>' +
